...
import info from "../assets/Screenshot from 2025-02-13 11-55-04.png";

const content: React.FC = () => {
  return (
    <section className="bg-transparent dark:bg-gray-900 mt-[2em]">
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 ">
        <img
          className="w-full h-[25em] border-2 border-gray-400 shadow-glow p-4 rounded-xl"
          src={info}
          alt="dashboard"
        />
        ...
        <div className="mt-4 md:mt-0">
          ...
          <p className="mb-6 font-light text-gray-300 md:text-lg dark:text-gray-400">
