    ...
    <footer className="section !pb-0">
      <div className="container">
        ...
        <div className="flex justify-between items-center py-6">
          {/* Flux Logo */}
          <Button className="text-2xl font-bold bg-gradient-to-t from-indigo-100 via-indigo-300 to-indigo-900 bg-clip-text text-transparent rounded-lg transition-all duration-300 hover:shadow-[2px_2px_0px_rgba(0,0,0,0.3)] hover:-translate-x-1 hover:-translate-y-1 hover:shadow-teal-200 hover:border hover:border-slate-600">
            Flux
          </Button>
