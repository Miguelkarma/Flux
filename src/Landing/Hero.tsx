...
export default function Hero() {
  return (
    <>
    <ParticlesBackground/>
      <section className="container flex min-h-[calc(100vh-3.5rem)] max-w-screen-2xl flex-col items-center justify-center space-y-8 py-24 text-center md:py-32 mt-16">
