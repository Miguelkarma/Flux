  ...
  return (
    <>
      ...
      <section className="container hero flex min-h-screen max-w-screen-2xl flex-col items-center justify-center space-y-8 py-32 text-center md:py-32">
        ...
        >
          <h1 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text  tracking-tight text-transparent text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
