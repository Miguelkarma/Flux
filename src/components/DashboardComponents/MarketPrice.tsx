    ...
    <div className="bg-black/30 backdrop-blur-sm rounded-xl p-4 h-full">
      <div className="flex justify-between items-center mb-3">
        <h3 className="text-lg font-semibold text-cyan-400">
          Equipment Market Prices
        </h3>
        <div className="flex gap-2">
          <select
            className="bg-black/50 text-cyan-400 text-xs rounded-md border border-gray-700 p-1"
            value={category}
          ...
          <button
            ...
            className="bg-black/50 text-cyan-400 p-1 rounded-md border border-gray-700"
            disabled={refreshing}
          >
            <RefreshCwIcon
              size={16}
            ...
            filteredProducts.map((item) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm font-mono">${item.price.toFixed(2)}</p>
                  <p
      ...
      <div className="mt-3 pt-2 border-t border-gray-700 flex justify-between items-center">
        <p className="text-xs text-gray-400">Live market data for IT assets</p>
