...
const Sparkle: React.FC<SparkleProps> = ({ width, deg, duration }) => {
  return (
    <span
      className="sparkle"
      style={
...
const Switch = () => {
  ...
  return (
    <StyledWrapper>
      <div className="toggle-cont p-[1px] flex items-center">
        <input
        ...
        <label
          ...
          htmlFor="toggle"
        >
          <div className="cont-icon flex items-center justify-center w-6 h-6 rounded-full">
            <Sparkle width={2} deg={25} duration={11} />
            <Sparkle width={1} deg={100} duration={18} />
            <Sparkle width={1} deg={280} duration={5} />
            <Sparkle width={2} deg={200} duration={3} />
            <Sparkle width={2} deg={30} duration={20} />
            <Sparkle width={2} deg={300} duration={9} />
            <Sparkle width={1} deg={250} duration={4} />
            <Sparkle width={2} deg={210} duration={8} />
            <Sparkle width={2} deg={100} duration={9} />
            <Sparkle width={1} deg={15} duration={13} />
            <Sparkle width={1} deg={75} duration={18} />
            <Sparkle width={2} deg={65} duration={6} />
            <Sparkle width={2} deg={50} duration={7} />
            <Sparkle width={1} deg={320} duration={5} />
            <Sparkle width={1} deg={220} duration={5} />
            <Sparkle width={1} deg={215} duration={2} />
            <Sparkle width={2} deg={135} duration={9} />
            <Sparkle width={2} deg={45} duration={4} />
            <Sparkle width={1} deg={78} duration={16} />
            <Sparkle width={1} deg={89} duration={19} />
            <Sparkle width={2} deg={65} duration={14} />
            <Sparkle width={2} deg={97} duration={1} />
            <Sparkle width={1} deg={174} duration={10} />
            <Sparkle width={1} deg={236} duration={5} />
            <svg
